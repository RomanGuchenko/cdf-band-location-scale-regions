...
| Path | Description |
| --- | --- |
| [`ls_note2_revised.pdf`](ls_note2_revised.pdf) | Public PDF of the research note |
| [`ls_note2_revised.tex`](ls_note2_revised.tex) | LaTeX source |
| [`simulate-confidence-intervals-reader-edition.pdf`](simulate-confidence-intervals-reader-edition.pdf) | Reader-oriented rendering of the chronological human-AI dialogue |
| [`simulate-confidence-intervals-transcript.pdf`](simulate-confidence-intervals-transcript.pdf) | Archival transcript as retrieved from the source conversation |
| [`location_scale_reference.R`](location_scale_reference.R) | Pedagogical reference implementation and reproduction drivers |
| [`location_scale_checks.R`](location_scale_checks.R) | Independent verification and regression checks |
| [`location_scale_research.ipynb`](location_scale_research.ipynb) | Computational notebook |
| [`location_scale_research.html`](location_scale_research.html) | Rendered notebook |
